                ...
                if len(검색결과) > 0:
                    ...
                    if 선택품목_idx and 선택품목_idx > 0:
                        ...
                        if 거래처:
                            ...
                            이전거래 = ledger_df[
                                (ledger_df['거래처'] == 거래처) & 
                                (ledger_df['품목'].str.contains(품목정보['품목명'], na=False)) &
                                (ledger_df['참조'] == '=외출')  # 판매만
                            ...
                            if len(이전거래) > 0:
                                ...
                                <div style='background-color: #e8f5e9; border: 2px solid #4caf50; border-radius: 8px; padding: 12px; margin: 10px 0;'>
                                    <h4 style='color: #2e7d32; margin: 0;'>📊 {거래처} 이전 납품 이력</h4>
                                </div>
                                """, unsafe_allow_html=True)
                                ...
                                for _, row in 이전거래.head(5).iterrows():
                                    ...
                                    st.markdown(f"""
                                    <div style='background-color: #f5f5f5; border-radius: 5px; padding: 8px; margin: 5px 0; color: #333;'>
                                        <span style='color: #666;'>{날짜_str}</span> | 
                                        <b>수량: {row['수량']:,.0f}</b> | 
