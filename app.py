        ...
        with col_info2:
            ...
            if 미수금 > 0:
                ...
                <div style='background-color: #fff3e0; border: 2px solid #e65100; border-radius: 10px; padding: 15px;'>
                    <h3 style='color: #e65100; margin: 0; font-size: 20px;'>⚠️ 미수금: {미수금:,.0f}원</h3>
                </div>
                """, unsafe_allow_html=True)
            elif 미수금 < 0:
                st.markdown(f"""
                <div style='background-color: #e8f5e9; border: 2px solid #2e7d32; border-radius: 10px; padding: 15px;'>
                    <h3 style='color: #2e7d32; margin: 0; font-size: 20px;'>💰 선수금: {abs(미수금):,.0f}원</h3>
                </div>
                """, unsafe_allow_html=True)
            else:
                st.markdown(f"""
                <div style='background-color: #e8f5e9; border: 2px solid #2e7d32; border-radius: 10px; padding: 15px;'>
                    <h3 style='color: #2e7d32; margin: 0; font-size: 20px;'>✅ 미수금 없음</h3>
                </div>
                """, unsafe_allow_html=True)
                ...
                if len(검색결과) > 0:
                    ...
                    if 선택idx > 0:
                        ...
                        <div style='background-color: #fff3e0; border: 2px solid #e65100; border-radius: 10px; padding: 12px; margin: 10px 0;'>
                            <h3 style='color: #e65100; margin: 0; font-size: 18px;'>📦 {품목명}</h3>
                        </div>
                        """, unsafe_allow_html=True)
